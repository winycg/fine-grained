...
parser.add_argument('--ratio', default=1., type=float, help='ratio of split training set')
...
parser.add_argument('--test-mode', type=str, default='TTA', help='test_mode: single or TTA')
